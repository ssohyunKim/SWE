...
class TodoList_ManagerTest {
	...
	void testUpdate() {
		TodoList todolist = new TodoList();
		assertTrue(todolistManager.update(todolists.get(0), "18-12-31", "18-12-01", "New Year") == FAIL);//Your Due date should be after register date.
		assertTrue(todolistManager.update(todolists.get(1), "18-12-25", "18-12-31", "Happy New Year") == SUCCESS);
		assertTrue(todolistManager.update(null, "18-11-25", "18-12-25", "merry christmas") == FAIL);//Empty
	}
	@Test
	void testDelete() {
